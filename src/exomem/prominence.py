...
CONTRACTS: dict[str, ProminenceContract] = {
    ...
    "balanced": ProminenceContract(
        ...
        capture=(
            ...
            "reusable facts, or carried-out method with a reported result. Capture stable "
            ...
            "associations, trivia, and tentative claims stay quiet. Route stated intent to "
    ...
    "maximal": ProminenceContract(
        ...
        capture=(
            ...
            "incidental associations, trivia, and tentative claims stay quiet. When torn between "
