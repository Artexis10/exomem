...
SERVER_INSTRUCTIONS = (
    ...
    "again with `anchor` set to the sense you mean. Do the same, with "
    "`anchor` set to the ref meant, when the turn points back at earlier work "
    "or at an entry the packet listed, and when the user corrects which page "
    "they meant. Use "
