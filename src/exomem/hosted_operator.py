...
_STABLE_ERROR_CLASSES = {
    ...
    "VOCABULARY_AUTHORITY_UNAVAILABLE": "unavailable",
    "VOCABULARY_RESTORE_REQUIRES_AUTHORITY": "conflict",
...
_COMMAND_ERRORS = {
    ...
    "restore-candidate": {
        ...
        "HOSTED_OPERATION_CONFLICT",
        "HOSTED_SECURITY_UNAVAILABLE",
        "VOCABULARY_AUTHORITY_UNAVAILABLE",
        "VOCABULARY_RESTORE_REQUIRES_AUTHORITY",
        "HOSTED_OPERATOR_INTERNAL",
    },
    "credential": {
        "HOSTED_OPERATOR_CONTRACT_INVALID",
