...
- A clean secret handoff proves the per-secret destination/version matrix without plaintext in state output, files, shell history, plans, or logs; separate Access, Tunnel, and root-key rotations prove overlap, rewrap, and retirement semantics.
