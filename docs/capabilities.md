...
- Tier 1 commands: 16
- Tier 2 commands: 3
- Registry-generated MCP commands: 19
- REST commands: 18
- CLI commands: 18
...
| schema_memory | 1 | MCP, REST, CLI | write | yes | - | schema_memory | operation*, name*, project, page_type, save, expected_hash, strict, compare_to | Infer, validate, or diff an optional corpus-backed memory contract. |
