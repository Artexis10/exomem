# hosted-tenant-cell Specification

## Purpose

Define explicit single-vault hosted-cell operation, tenant-isolated runtime state, readiness, observability, optional compute, and lifecycle behavior.
