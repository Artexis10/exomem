# authorization-session-binding Specification

## Purpose
Bind ephemeral governance authority to server-issued, principal-scoped capabilities
whose protected carriers, external custody, lifecycle, migration, and persisted state
remain consistent across every generated surface and fail closed on ambiguity.
## Requirements
