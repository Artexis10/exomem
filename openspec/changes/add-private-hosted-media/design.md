...
The task 1.1 reconciliation baseline is Exomem `07d28b6` and Substrate `deb7b63`. These source contracts are the dispatch inputs; the launch owner still controls their production release. Recheck changed interfaces before dispatch/integration instead of treating this snapshot as launch completion.
