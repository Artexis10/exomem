...
The utility action family SHALL admit context-activation variants as an extension of
its variant tuple, each variant binding one cold-start case or twin to a seeded action
...
- **WHEN** the variant tuple is extended with context-activation variants
