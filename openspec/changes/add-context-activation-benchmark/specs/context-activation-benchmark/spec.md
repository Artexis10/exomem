...
retrieval is run. The audit SHALL score each case and each anchor kind separately,
...
clock held constant: A1 control with Exomem absent; A2 raw recall with `ask_memory`
...
use and a p95 packet at most 1,500 tokens; and indeterminate otherwise. Every run
