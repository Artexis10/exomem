...
- [x] 1.4 Add a supervisor-harness test that performs a real worker handoff and asserts the first ten writes after promotion are incremental with no whole-vault rebuild; pass the managed-service e2e, ingress and service-manager suites.
