...
- [x] 3.4 Implement bounded derived graph quarantine/reset under the existing mutation boundary and wire the default-false parameter through reconcile, maintain-memory, CLI, REST, MCP, and generated schema fixtures.
