...
- Intended implementation commit `99b2fc68` and current-main integration commit `74f97a2d` were pushed to ready PR #418 with Conventional-Commit title `feat(planning): add multi-horizon planning`; the PR remains unmerged pending separate authorization.
