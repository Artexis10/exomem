...
- [x] 2.3 Execute each binding through `record_governance.resolve_collection`, `record_governance.query_collection`, and `record_governance.project_query_result`; extract only matched, returned, truncated, aggregate, and snapshot.
