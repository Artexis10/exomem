...
- **GIVEN** an unresolved identity is linked from three `index.md` pages and from one ordinary eligible page
- **WHEN** the audit sweeps `entity_recurrence`
- **THEN** zero findings are produced for that identity
