...
- [ ] 3.1 Run durable-closure regression coverage and the completion-boundary test suite; record results without attributing prior workflow gains to the framework.
...
- [ ] 3.3 Run lint, public-artifact privacy and strict OpenSpec validation; commit and push a ready PR with the verified scope and release instructions.
