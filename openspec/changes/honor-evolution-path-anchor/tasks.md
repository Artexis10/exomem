...
## 1. Product
- [ ] 1.1 Red-first test proving `review_memory --mode evolution --path <p>`
...
- [ ] 1.2 Anchor semantics documented in the op docstring / tool surface
...
- [ ] 2.1 `journeys.py` envelope doc corrected ("oldest path" → "requested
...
## 3. Validation
- [ ] 3.1 `openspec validate honor-evolution-path-anchor --strict`
