...
3. Refresh Substrate PR #32, update the exact fixture/release, add Access headers, direct-transfer tickets, and pending/final action waiting, fix deployment CI, and verify migrations/Paddle webhooks.
