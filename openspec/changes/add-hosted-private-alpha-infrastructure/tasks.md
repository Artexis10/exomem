...
- [x] 6.6 Add the separate HCP Terraform state-only bootstrap, fixed production workspaces, fail-closed preflight, and disposable proof workspace; prove real-account concurrent locking and prior-version recovery before any production apply.
