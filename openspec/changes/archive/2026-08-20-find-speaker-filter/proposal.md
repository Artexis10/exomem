...
- Code: `src/exomem/find.py` (`Page.speakers`, `speakers` param threaded through `find` + helpers +
  `_passes_filters`), `src/exomem/commands.py` (the `find` command param + docstring), the regenerated
