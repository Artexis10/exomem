...
#     authorizing your domain's zone). This step is browser-interactive,
...
if (-not (Test-Path $CertPem)) {
    throw "No cert.pem at $CertPem. Run 'cloudflared tunnel login' first (browser auth for your domain's zone)."
}
