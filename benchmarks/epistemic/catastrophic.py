...
PREREGISTRATION.md §3 names six invariants whose failure is an integrity
...
external edit. Each is a harm no retrieval or answer excellence can offset, so
a failure suppresses every aggregate for that provider rather than averaging
into one.
